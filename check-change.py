...
def main():
    ...
    if has_content_changed(new_content, repo_path, current_version_file):
        ...
        with open(f"{repo_path}/versions/version_{date_suffix}.md", 'w',encoding='utf-8') as file:
            file.write(new_content)
        with open(f"{repo_path}/versions/{current_version_file}", 'w',encoding='utf-8') as file:
            file.write(new_content)
